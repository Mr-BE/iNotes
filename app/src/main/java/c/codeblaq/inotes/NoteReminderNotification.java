...
public class NoteReminderNotification {
    ...
    public static void notify(final Context context, final String noteTitle,
        ...
        String idChannel = "my_chanel_01";
        String channelName = "My Channel";
        String notifDesc = "Review Note";

        int notifImportance = NotificationManager.IMPORTANCE_DEFAULT;
        NotificationChannel channel = new NotificationChannel(idChannel, channelName, notifImportance);
        ...
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.andel);

        //Backup service intent
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context, idChannel)
                ...
                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText(noteText) //Body of notification
                        .setBigContentTitle(noteTitle) //Header
                        .setSummaryText("Review note")) //Summary of Notification
                ...
                // the notification.
                .setContentIntent(//Primary intent action
                        PendingIntent.getActivity(
                                context,
                                0,
                                noteActivityIntent,
                                PendingIntent.FLAG_UPDATE_CURRENT))
                //Intent additional actions
                .addAction(
                        0,// no icon
                        "View all notes",
                        PendingIntent.getActivity(
                                ...
                                PendingIntent.FLAG_UPDATE_CURRENT))
                //Backup notes notification pending intent
                .addAction(
                        0,// no icon
                        "Backup notes",
